...
# the next 3 just concatenate with dash, pipe, and space delimeters respectively
...
# this is used for place and subjects
...
for filename in os.listdir(directory):
    if filename.endswith(".csv"):
        ...
        with open(directory + filename, mode='r') as infile:
            ...
            csvContent = csv.reader((line.replace('\0','') for line in infile), delimiter=",")
            header = []
            count = 0
