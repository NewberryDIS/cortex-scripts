...
merged_df = pd.merge(df1, df2, left_on='Original file name', right_on='Production Number', how='outer', suffixes=('_left', '_right'))

# Create the Link2 column based on the merged DataFrame
# merged_df['Link2'] = merged_df['Link to view in Cortex']

# Select relevant columns
result_df = merged_df[['Unique identifier', 'Original file name', 'Production Number', 'Decade', 'Sort Date']]
